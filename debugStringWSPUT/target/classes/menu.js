...
// Function to handle delete as well as other events on marker popup open
    function onPopupOpen() {
        ...
        $(".message-adder-button").click(function () {
            ...
            document.getElementById("finisherMessage").onclick = function(){
                ...
                /*if(Object.keys(tempMarker.feature.properties.contentJson.messageList).length == 1){
                    $("#listOfMessage").append('<div class="carousel-item active">'+ document.getElementById("messager").value +'</div>');
                }else{
                    $("#listOfMessage").append('<div class="carousel-item">'+ document.getElementById("messager").value +'</div>');
                }*/
                //console.log(tempMarker.feature.properties.contentJson.messageList);
    ...
    function messageDefiler(c) {
        console.log(Object.keys(c.messageList).length);
        console.log(c.messageList);
        $("#listOfMessage").append('<div class="carousel-item-active">'+ c.messageList[0] +'</div>');
        for(var i = 1 ; i < Object.keys(c.messageList).length ; i++){
            $("#listOfMessage").append('<div class="carousel-item">'+ c.messageList[i] +'</div>');
        }
    }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    document.getElementById("finisherMap").onclick = function(){ //Quand on a finit de créer la map, on l'envoie vers le serveur
        ...
        console.log(name);
        putServerData("ws/impl/mapimpl/addmap",{name: name}, result =>{ //Appel à PUT pour aller vers vers le addMap de MapRessourceImplStub.java
            console.log(result);
        });
    };
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
